    ...
    public class MoodAnalyserFactory
    {
        ...
        public static string InvokeAnalyseMood(string message, string methodName)
        {
            try
            {
                ...
                object moodAnalyseObject = MoodAnalyserFactory.CreateMoodAnalyseUsingParameterizedConstructor("MoodAnalyser.MoodAnalyser", "MoodAnalyser", message);
